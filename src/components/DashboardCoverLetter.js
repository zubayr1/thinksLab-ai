      ...
      <Grid>
          ...
          <main style={{ minHeight: '100vh' }}>
            <div id='left-area' style={{ position: 'fixed', display: 'flex', height: '100vh', zIndex: 1 }}>
              {visible && (
                <nav style={{ flex: 1, overflowY: 'auto', width: '300px' }}>
                  <Leftbar email={""} newanswer={newanswer} onnewchat={handlenewchat} />
                </nav>
              )}
              <div
                style={{
            ...
            <div id='right-area' style={{ marginLeft: `${visible ? '300px' : '0px'}` }}>
              <CoverLetter email={""} visible={visible} chat={chat} onVisibleChange={handleVisibleChange} onNewAnswer={handleNewAnswer} />
            </div>
          </main>
            ...
            <div>
              ...
              <Sidebar.Pusher dimmed={visible}>
                  ...
                  <div className='main-content'>
                    <CoverLetter email={""} visible={visible} chat={chat} onHide={() => setVisible(false)} onVisibleChange={handleVisibleChange} onNewAnswer={handleNewAnswer}/>
                  </div>
