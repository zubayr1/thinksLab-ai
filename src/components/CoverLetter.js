...
function CoverLetter({email, visible, chat, onVisibleChange, onNewAnswer}) {
    ...
    useEffect(() =>       // resetting chats
    {
        if (isnewchat && chat > 1) {
            ...
            axios.post(`${baseURL}/coverletterbot`, {email, selected_option, messagetype, questions_set, prev, tokens, question},
                {
                    headers: {
    ...
    const handle_submit = async (e) =>        // get AI output from backend based on user question
    {
        ...
        if (tokens <= MAXTOKEN) {
            if (question !== "" && !submitted) {
                ...
                axios.post(`${baseURL}/coverletterbot`, {
                    email,
                    selected_option,
                    messagetype,
                    questions_set,
            ...
            <Grid centered>
                ...
                <Grid.Column verticalAlign='middle' width={16} only='computer tablet'>
                    ...
                    <div style={{minHeight: '90vh'}}>
                        ...
                        <div
                            style={{paddingLeft: '15%', paddingRight: '15%', paddingTop: '15%', paddingBottom: '10%',}}>
