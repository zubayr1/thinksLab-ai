...
import AdminGreetings from './AdminGreetings.js'
import {db} from "../../firebase.js"
import {auth} from '../../firebase.js';
import "../chatbot.css";


function AdminChatbot({email, visible, chat, onVisibleChange, onNewAnswer}) {
        ...
        <div  >
            ...
            <Grid centered>
                ...
                <Grid.Column verticalAlign='middle' width={16} only='computer tablet'>
                    ...
                    <AdminHeader visible={visible} onVisibleChange={onVisibleChange}/>
